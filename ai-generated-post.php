...
class AIGN_Post {
	...
	function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'aignpost_admin_styles' ) );
	}
	...
	function aignpost_admin_styles( $page_hook ) {
		...
		if ( 'toplevel_page_aignpost-dashboard' == $page_hook || 'aign-post_page_aignpost-settings' == $page_hook || 'aign-post_page_aignpost-generate' == $page_hook ) {
			wp_enqueue_style( 'milligram-css', AIGN_PLUGIN_DIR_URL . "admin/css/milligram.min.css", null, '1.1.0' );
		}
	}
